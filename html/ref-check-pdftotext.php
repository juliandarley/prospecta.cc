...
<body>
    ...
    <p>First, simple version: case-insensitive substring match on per-page pdftotext output with disk cache; returns first hit per page with a highlighted snippet.</p>
    <div class="row">
